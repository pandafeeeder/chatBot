<template>
  <div class="home main-bg t-c">
    <div class="header w-m">
      <div class="title t-c l-38">ChatGPT-edit</div>
    </div>
    <div class="content">
          ...
          <div class="">
            <div v-for="(item, index) in messages" :key="index" :class="{
              ...
              <div class="flex row t-c" :class="{
                ...
                <div v-else class="a-end f-16 l-24 p-l-10 p-t-10 p-r-10 p-b-10 br-12" :class="{
...
const send = (value) => {
  ...
  qa(promots.slice(-1)[0].content, "edit")
    .then((data) => {
      data = data.data;
